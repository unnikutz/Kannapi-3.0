...
global.bucin = [
   ...
   "Romeo is willing to die for Juliet, Jack died because he saved Rose. The point is, if you still want to live, be single.",
   "I'm looking for people not from their strengths but I'm looking for people from their sincerity.",
   "Matchmaking is not flip flops, which are often switched. So, keep in the struggle that should be.",
   ...
   "Do you know the difference between going to school and going to your house? When you go to school, books and pens are definitely what you bring, but if you go to your house, I just need to bring my heart and love."
   ...
   "My homework is missing you. Stronger than Math, wider than Physics, stronger than Biology.",
   ...
   "I ora never understood opo kui tresno, kajaba sak bare found karo sliramu.",
   ...
   "Hayang, the rasana kuring arranges the words of love in Dunya Ieu, then I curry bade together, so that I will get bigger and feel like my love is curling,",
   "Calm down wae neng, out of love, you, you know the song Krispatih; timeless.",
   "Abdi sanes jalmi nu sampurna pikeun anjeun, sareng sanes oge nu is the most alus kanggo anjeun. But sure, servant jalmi hiji-hijina nu keep emut ka anjeun.",
